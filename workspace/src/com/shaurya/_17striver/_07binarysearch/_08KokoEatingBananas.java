 ...
 */
public class _08KokoEatingBananas {
    public static void main(String[] args) {
        int N = 4, a[] = {7, 15, 6, 3}, h = 8;
        int minCount = findMinimumNumber(N, a, h);
        System.out.println(minCount);
    }

    private static int findMinimumNumber(int n, int[] a, int h) {
        int low = 1;
        int high = Arrays.stream(a).boxed().max(Integer::compareTo).get();
    ...
    private static int calculate(int[] arr, int mid) {
        int total = 0;
